...
* #paidbypatientcash "Paid by patient - cash" "The amount paid by the patient at the point of service using cash, check, or other personal account."
* #paidbypatientlinkedaccount "Paid by patient - linked account" "The amount paid by the patient at the point of service using an account linked to their benefits such as an HSA or HRA."
