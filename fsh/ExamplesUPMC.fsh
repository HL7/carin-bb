...
* class[0].type.coding[0].system = $CoverageClassCS
...
* class[1].type.coding[0].system = $CoverageClassCS
...
* class[2].type.coding[0].system = $CoverageClassCS
...
* managingOrganization = Reference(Organization1UPMC)
...
* item[0].adjudication[adjudicationamounttype][0].category.coding[0].system = $C4BBAdjudicationCS
* item[0].adjudication[adjudicationamounttype][0].category.coding[0].code = #memberliability
* item[0].adjudication[adjudicationamounttype][0].category.coding[0].display = "Member liability"
* item[0].adjudication[adjudicationamounttype][0].category.text = "The amount of the member's liability."
* item[0].adjudication[adjudicationamounttype][0].amount.value = 35.0
* item[0].adjudication[adjudicationamounttype][0].amount.currency = #USD
* item[0].adjudication[adjudicationamounttype][1].category.coding[0].system = $HL7AdjudicationCS
* item[0].adjudication[adjudicationamounttype][1].category.coding[0].code = #submitted
* item[0].adjudication[adjudicationamounttype][1].category.coding[0].display = "Submitted Amount"
* item[0].adjudication[adjudicationamounttype][1].category.text = "The total submitted amount for the claim or group or line item."
* item[0].adjudication[adjudicationamounttype][1].amount.value = 40.0
* item[0].adjudication[adjudicationamounttype][1].amount.currency = #USD
* item[0].adjudication[adjudicationamounttype][2].category.coding[0].system = $HL7AdjudicationCS
* item[0].adjudication[adjudicationamounttype][2].category.coding[0].code = #copay
* item[0].adjudication[adjudicationamounttype][2].category.coding[0].display = "CoPay"
* item[0].adjudication[adjudicationamounttype][2].category.text = "Patient Co-Payment"
* item[0].adjudication[adjudicationamounttype][2].amount.value = 0.0
* item[0].adjudication[adjudicationamounttype][2].amount.currency = #USD
* item[0].adjudication[adjudicationamounttype][3].category.coding[0].system = $HL7AdjudicationCS
* item[0].adjudication[adjudicationamounttype][3].category.coding[0].code = #eligible
* item[0].adjudication[adjudicationamounttype][3].category.coding[0].display = "Eligible Amount"
* item[0].adjudication[adjudicationamounttype][3].category.text = "Amount of the change which is considered for adjudication."
* item[0].adjudication[adjudicationamounttype][3].amount.value = 35.0
* item[0].adjudication[adjudicationamounttype][3].amount.currency = #USD
* item[0].adjudication[adjudicationamounttype][4].category.coding[0].system = $HL7AdjudicationCS
* item[0].adjudication[adjudicationamounttype][4].category.coding[0].code = #deductible
* item[0].adjudication[adjudicationamounttype][4].category.coding[0].display = "Deductible"
* item[0].adjudication[adjudicationamounttype][4].category.text = "Amount deducted from the eligible amount prior to adjudication."
* item[0].adjudication[adjudicationamounttype][4].amount.value = 35.0
* item[0].adjudication[adjudicationamounttype][4].amount.currency = #USD
* item[0].adjudication[adjudicationamounttype][5].category.coding[0].system = $HL7AdjudicationCS
* item[0].adjudication[adjudicationamounttype][5].category.coding[0].code = #benefit
* item[0].adjudication[adjudicationamounttype][5].category.coding[0].display = "Benefit Amount"
...
* item[1].adjudication[1].category.coding[0].system = $HL7AdjudicationCS
...
* item[1].adjudication[2].category.coding[0].system = $HL7AdjudicationCS
...
* item[1].adjudication[3].category.coding[0].system = $HL7AdjudicationCS
...
* item[1].adjudication[4].category.coding[0].system = $HL7AdjudicationCS
...
* item[1].adjudication[5].category.coding[0].system = $HL7AdjudicationCS
...
* total[0].category.coding[0].system = $HL7AdjudicationCS
...
* total[1].category.coding[0].system = $HL7AdjudicationCS
...
* total[2].category.coding[0].system = $HL7AdjudicationCS
...
* total[3].category.coding[0].system = $HL7AdjudicationCS
...
* total[5].category.coding[0].system = $HL7AdjudicationCS
...
* diagnosis[0].type[0].coding[0].system = $HL7DiagnosisType
* diagnosis[0].type[0].coding[0].code = #principal
* diagnosis[0].type[0].text = "principal"
* procedure[0].sequence = 1
* procedure[0].type[0].coding[0].system = $HL7ProcedureType 
* procedure[0].type[0].coding[0].code = #primary
* procedure[0].type[0].text = "Primary procedure"
...
* item[0].adjudication[1].category.coding[0].system = $HL7AdjudicationCS
...
* item[0].adjudication[2].category.coding[0].system = $HL7AdjudicationCS
...
* item[0].adjudication[3].category.coding[0].system = $HL7AdjudicationCS
...
* item[0].adjudication[4].category.coding[0].system = $HL7AdjudicationCS
...
* item[0].adjudication[5].category.coding[0].system = $HL7AdjudicationCS
