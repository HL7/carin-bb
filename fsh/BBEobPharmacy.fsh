...
* item[0].adjudication[adjudicationamounttype][0].category = C4BBAdjudication#coinsurance "Beneficiary Coinsurance Amount"
...
* item[0].adjudication[adjudicationamounttype][1].category = C4BBAdjudication#paidtoprovider "Paid to provider"  
...
// * item[0].adjudication[3].category = C4BBAdjudication#allowed "Allowed"
...
* item[1].adjudication[adjudicationamounttype][0].category = C4BBAdjudication#coinsurance "Beneficiary Coinsurance Amount"
...
* item[1].adjudication[adjudicationamounttype][1].category = C4BBAdjudication#paidtoprovider "Paid to provider"  
...
// * item[2].adjudication[adjudicationamounttype][3].category = C4BBAdjudication#allowed "Allowed"
...
* item[2].adjudication[adjudicationamounttype][0].category = C4BBAdjudication#coinsurance "Beneficiary Coinsurance Amount"
...
* item[2].adjudication[adjudicationamounttype][1].category = C4BBAdjudication#paidtoprovider "Paid to provider"  
...
// * item[1].adjudication[3].category = C4BBAdjudication#allowed "Allowed"
