...
<ul>
  ...
  <li>Updated the EOB-pharm-careTeam-practitioner invariant on the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Pharmacy-Basis.html">ExplanationOfBenefit Pharmacy Basis Profile</a> to require the primary or prescribing role careTeam to refer to a Practitioner instead of Organization. (<a href="https://jira.hl7.org/browse/FHIR-55581">FHIR-55581</a>)</li>
  <li>Removed the EOB-inst-careTeam-organization invariant on the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Inpatient-Institutional.html">Inpatient Institutional</a> and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Outpatient-Institutional.html">Outpatient Institutional</a> profiles (<a href="https://jira.hl7.org/browse/FHIR-53472">FHIR-53472</a>)</li>
  <li>Change the max cardinality of the reject reason adjudication slice to be unbounded in the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Pharmacy.html">Pharmacy ExplanationOfBenefit profile</a> (<a href="https://jira.hl7.org/browse/FHIR-53297">FHIR-53297</a>)</li>
  <li>Added paidbypatienthealthaccount code to the <a href="ValueSet-C4BBAdjudication.html">Adjudication ValueSet</a> (<a href="https://jira.hl7.org/browse/FHIR-51008">FHIR-51008</a>)</li>
  <li>Removed the max cardinality restriction on the item adjudication adjustmentreason slice on the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Professional-NonClinician.html">Professional NonClinician ExplanationOfBenefit</a> and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Oral.html">Oral EOB</a> profiles (<a href="https://jira.hl7.org/browse/FHIR-49140">FHIR-49140</a>)</li>
  <li>Updated the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Inpatient-Institutional.html">Inpatient Institutional</a> and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Outpatient-Institutional.html">Outpatient Institutional</a> profiles to allow the provider to be a Practitioner (<a href="https://jira.hl7.org/browse/FHIR-40593">FHIR-40593</a>)</li>
  <li>Added guidance for using CPT(R) consumer friendly descriptors to <a href="General_Guidance.html#considerations-for-improving-interoperability">Considerations for Improving Interoperability</a> section (<a href="https://jira.hl7.org/browse/FHIR-40361">FHIR-40361</a>)</li>
  <li>Updated the <a href="StructureDefinition-C4BB-Organization.html">Organization</a> profile to remove additional NAIC and NPI constraints (above US Core Organization) and restrict NPI to a max occurrence of 1. (<a href="https://jira.hl7.org/browse/FHIR-53209">FHIR-53209</a>)</li>
  <li>Updated the <a href="StructureDefinition-C4BB-Practitioner.html">Practitioner</a> profile to remove NPI identifier type requirements and updated the Invariant to utilize system to require an NPI or Tax ID (<a href="https://jira.hl7.org/browse/FHIR-48320">FHIR-48320</a>).</li>
  <li>Added a note to not use ICD-10-CM header code in all places where ICD-10-CM is included. (<a href="https://jira.hl7.org/browse/FHIR-48743">FHIR-48743</a>)</li>
  <li>Added a note about how to include a diagnosis code that is represented by two different types of diagnosis (e.g. principle and admitting) to the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Inpatient-Institutional-Basis.html">Inpatient Institutional Basis</a>, <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Inpatient-Institutional.html">Inpatient Institutional</a>, <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Outpatient-Institutional-Basis.html">Outpatient Institutional Basis</a>, and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Outpatient-Institutional.html">Outpatient Institutional</a> (<a href="https://jira.hl7.org/browse/FHIR-44860">FHIR-44860</a>).</li>
  <li>Updated the IG specification introduction on the <a href="index.html">home</a> page (<a href="https://jira.hl7.org/browse/FHIR-53479">FHIR-53479</a>).</li>
  <li>Added IP statement for CPT on <a href="downloads.html">Downloads</a> page where the IP statements are (<a href="https://jira.hl7.org/browse/FHIR-53593">FHIR-53593</a>)</li>      
</ul>
...
<ul>
  <li>Changed base profile of the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Patient.html">Patient</a>, <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Coverage.html">Coverage</a>, <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Practitioner.html">Practitioner</a>, <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Organization.html">Organization</a>, and <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-RelatedPerson.html">RelatedPerson</a> to <a href="https://hl7.org/fhir/us/core/STU6.1/">US Core 6.1</a> and added complies with requirements to <a href="https://hl7.org/fhir/us/core/STU3.1.1/">US Core 3.1.1</a> where there was a profile in that version (<a href="https://jira.hl7.org/browse/FHIR-46374">FHIR-46374</a>) <br/>Note: Most of the changes from US Core 3.1.1 to 6.1 are reductions in Must Support requirements, but there are a small number of breaking changes to note, including:
    <ul>
      <li>The <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Coverage.html">Coverage</a> profile now requires the member identifier, if present, to have a type of <code>MB</code> from system <code>http://terminology.hl7.org/CodeSystem/v2-0203</code>. The previous version of this profile did not have specific requirements for the member ID, though the example had a member ID that matched US Core 6.1 requirements.</li>
      <li>The <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Coverage.html">Coverage</a> profile now has an extensible binding to a ValueSet to Coverage.type, where there was no previous binding.</li>
      <li>The <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Organization.html">Organization</a> and <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-Organization.html">Practitioner</a> profiles now have ID validation checks for NPI and CLIA numbers</li>
    </ul>
  </li>
  ...
  <li>Removed the US Surface Codes System and updated the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/ValueSet-C4BBSurfaceCodes.html">US Surface Codes Set Value Set</a> to point to the <a href="https://terminology.hl7.org/CodeSystem-ADAToothSurfaceCodes.html">ADA Tooth Surface Codes CodeSystem</a> (This requires a code system change from <code>http://hl7.org/fhir/us/carin-bb/CodeSystem/C4BBSurfaceCodes</code> to <code>http://terminology.hl7.org/CodeSystem/ADAToothSurfaceCodes</code> for resources claiming conformance) (<a href="https://jira.hl7.org/browse/FHIR-47140">FHIR-47140</a>)</li>
  ...
  <li>Added a <code>masked</code> Data Absent Reason Code to the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/ValueSet-CDCICD910CMDiagnosisCodes.html">Diagnosis Codes ValueSet</a> to allow for masking of sensitive diagnosis codes. (<a href="https://jira.hl7.org/browse/FHIR-40441">FHIR-40441</a>)</li>
  ...
  <li>Fixed the expression for the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/SearchParameter-explanationofbenefit-service-start-date.html">Service Start Date SearchParameter</a> (<a href="https://jira.hl7.org/browse/FHIR-46376">FHIR-46376</a>)</li>
  <li>Added the ability for the ExplanationOfBenefit.provider to be an Organization for the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/StructureDefinition-C4BB-ExplanationOfBenefit-Oral.html">Oral EOB Profile</a> (<a href="https://jira.hl7.org/browse/FHIR-44662">FHIR-44662</a>)</li>
  <li>Removed the inclusion of codes in <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/ValueSet-C4BBPayerBenefitPaymentStatus.html">Benefit Payment Status</a> from the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/ValueSet-C4BBTotalCategoryDiscriminator.html">C4BB Total Category Discriminator Value Set</a> (<a href="https://jira.hl7.org/browse/FHIR-40245">FHIR-40245</a>)</li>
  ...
  <li>Updated guidance for the <a href= "https://hl7.org/fhir/us/carin-bb/STU2.1/SearchParameter-explanationofbenefit-service-date.html">Service Date Search Parameter</a> to state that the search parameter is to simplify the search in case the client does not know the specific date type to search for based on EOB type. (<a href="https://jira.hl7.org/browse/FHIR-41634">FHIR-41634</a>)</li>
  <li>Clarified search removing the need for a patient search argument in the <a href = "https://hl7.org/fhir/us/carin-bb/STU2.1/CapabilityStatement-c4bb.html">Capability Statement</a>. (<a href="https://jira.hl7.org/browse/FHIR-41628">FHIR-41628</a>)</li>
  <li>Improved the <a href="https://hl7.org/fhir/us/carin-bb/STU2.1/ExplanationOfBenefit-EOBProfessional1.html">EOB Professional 1 example</a> to include more realistic amounts and a payee. (<a href="https://jira.hl7.org/browse/FHIR-43464">FHIR-43464</a>)</li>
