...
<ul>
  ...
  <li>Removed the EOB-inst-careTeam-organization invariant on the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Inpatient-Institutional.html">Inpatient Institutional</a> and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Outpatient-Institutional.html">Outpatient Institutional</a> profiles (<a href="https://jira.hl7.org/browse/FHIR-53472">FHIR-53472)</li>
  <li>Change the max cardinality of the reject reason adjudication slice to be unbounded in the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Pharmacy.html">Pharmacy ExplanationOfBenefit profile</a> (<a href="https://jira.hl7.org/browse/FHIR-53297">FHIR-53297)</li>
  <li>Added paidbypatienthealthaccount code to the <a href="ValueSet-C4BBAdjudication.html">Adjudication ValueSet</a> (<a href="https://jira.hl7.org/browse/FHIR-51008">FHIR-51008)</li>
  <li>Removed the max cardinality restriction on the item adjudication adjustmentreason slice on the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Professional-NonClinician.html">Professional NonClinician ExplanationOfBenefit</a> and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Oral.html">Oral EOB</a> profiles (<a href="https://jira.hl7.org/browse/FHIR-49140">FHIR-49140)</li>
  <li>Updated the <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Inpatient-Institutional.html">Inpatient Institutional</a> and <a href="StructureDefinition-C4BB-ExplanationOfBenefit-Outpatient-Institutional.html">Outpatient Institutional</a> profiles to allow the provider to be a Practitioner (<a href="https://jira.hl7.org/browse/FHIR-40593">FHIR-40593)</li>
  <li>Added guidance for using CPT(R) consumer friendly descriptors to <a href="General_Guidance.html#considerations-for-improving-interoperability">Considerations for Improving Interoperability</a> section (<a href="https://jira.hl7.org/browse/FHIR-40361">FHIR-40361)</li>
  <li>Updated the <a href="StructureDefinition-C4BB-Organization.html">Organization</a> profile to remove additional NAIC and NPI constraints (above US Core Organization) and restrict NPI to a max occurrence of 1. (<a href="https://jira.hl7.org/browse/FHIR-53209">FHIR-53209)</li>
  <li>Updated the <a href="StructureDefinition-C4BB-Practitioner.html">Practitioner</a> profile to remove NPI identifier type requirements and updated the Invariant to utilize system to require an NPI or Tax ID (<a href="https://jira.hl7.org/browse/FHIR-48320">FHIR-48320).</li>
  <li>Added a note to not use ICD-10-CM header code in all places where ICD-10-CM is included. (<a href="https://jira.hl7.org/browse/FHIR-48743">FHIR-48743)</li>
