...
/*
Instance: OrganizationNonContained
InstanceOf: C4BBOrganization
Description: "Provider 1"
Usage: #example
* meta.lastUpdated = "2019-12-12T09:14:11+00:00"
...
* name = "Provider 1"
* active = true
* partOf = Reference(OrganizationContained)


Instance: OrganizationContained
InstanceOf: C4BBOrganization
Description: "Provider 1"
Usage: #inline
//* meta.profile = Canonical(C4BBOrganization)
...
Instance: EOBOutpatientInstitutional_ContainedOrg1
InstanceOf: C4BBExplanationOfBenefitOutpatientInstitutional
Description: "EOB Outpatient Example ContainedOrg1"
Usage: #example
* id = "EOBOutpatientInstitutionalContainedOrg1"
//* id = "1234-234-1243-12345678901-20190101-20191031"
//* meta.profile = Canonical(C4BBExplanationOfBenefitOutpatientInstitutional)
* meta.lastUpdated = "2019-12-12T09:14:11+00:00"
* contained[0] = OrganizationContained
...
* use = #claim
* created = "2019-11-02T00:00:00+00:00"
* insurer = Reference(OrganizationContained)
* insurer.display = "XXX Health Plan"
* patient = Reference(Patient1)
* billablePeriod.start = "2019-01-01"
* billablePeriod.end = "2019-10-31"
