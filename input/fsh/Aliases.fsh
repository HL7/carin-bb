...
Alias: $ex-diagnosistype = http://terminology.hl7.org/CodeSystem/ex-diagnosistype|1.0.1
Alias: $data-absent-reason = http://terminology.hl7.org/CodeSystem/data-absent-reason|1.0.0
...
Alias: $adjudication = http://terminology.hl7.org/CodeSystem/adjudication|1.0.1
...
Alias: $USCoreProviderSpecialty = http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.114222.4.11.1066|20240606
...
Alias: $ICD9PCS = http://hl7.org/fhir/sid/icd-9-cm
Alias: $CPT = http://www.ama-assn.org/go/cpt
