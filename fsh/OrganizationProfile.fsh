...
* identifier[payerid] ^definition = "Code of the payer responsible for the claim (2)"
...
* identifier[naiccode] ^definition = "NAIC Code of the payer responsible for the claim (2)"
...
* identifier[NPI] ^definition = "The National Provider Identifier assigned to the Billing Provider, Care Team members and the Service Facility (93, 94, 95, 97, 99, 100, 122, 173)"
* identifier[NPI] ^comment = "Service Facility NPI will be populated with the value 'NPI has not been assigned' if an NPI has not been assigned to the Service Location Organization"
